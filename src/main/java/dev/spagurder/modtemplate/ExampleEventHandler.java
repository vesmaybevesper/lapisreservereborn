...
public class ExampleEventHandler {
    ...
    public static void onPlayerHurt(ServerPlayer player) {
        ...
        if (player.getServer().pvp) {
            LapisReserveReborn.LOG.info("{} took damage. PVP is allowed.", player.getDisplayName());
        } else {
            LapisReserveReborn.LOG.info("{} took damage. PVP is disallowed.", player.getDisplayName());
        }
    }
